...
<body>
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item">Bilim</span>
        </div>
    </div>
    <section class="static about-sec">
        <div class="container">

            <h2>Bilim Kitapları</h2>
            <div class="recent-book-sec">
                <div class="row">
                    <?php
                    $data = new veri();
                    $result = $data->GetBilim();
                    while($data=mysqli_fetch_array($result)):
                    ?>
                    <div class="col-md-3">
                        <div class="item">
                            <img src="../../images/Bilim/<?php echo $data["kitap_link"]; ?>" alt="img">
                            <h3><a href="../kitapDetay/Bilim.php?type=<?php echo $data["kitap_id"]?>"><?php echo $data["kitap_ismi"]; ?></a></h3>
                ...
                <div class="btn-sec">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-circle pg-blue">
                          ...
                          <li class="page-item active"><a class="page-link" href="Bilim.php">1</a></li>
