...
<body>
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <h2>Deneme Kitapları</h2>
            <div class="recent-book-sec">
                <div class="row">
                    <?php
                    $data = new veri();
                    $result = $data->GetDeneme();
                    while($data=mysqli_fetch_array($result)):
                    ?>
                    <div class="col-md-3">
                        <div class="item">
                            <img src="../../images/Deneme/<?php echo $data["kitap_link"]; ?>" alt="img">
                            <h3><a href="../kitapDetay/Deneme.php?type=<?php echo $data["kitap_id"]?>"><?php echo $data["kitap_ismi"]; ?></a></h3>
                ...
                <div class="btn-sec">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-circle pg-blue">
                          ...
                          <li class="page-item active"><a class="page-link" href="/Deneme.php">3</a></li>
